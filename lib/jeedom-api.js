...
JeedomClient.prototype.getModel = function() {
	...
	return new Promise(function(resolve, reject) {
		...
		var myPlugin = "mobile";
		if(is_object(plugin::byId('homebridge'))) myPlugin="homebridge";
		request.post(url, {
			json : true,
			gzip : true,
			form : {
				request : '{"jsonrpc":"2.0","id":"'+request_id+'","method":"sync_homebridge","params":{"plugin":"'+myPlugin+'","apikey":"' + that.apikey + '"}}'
			}
