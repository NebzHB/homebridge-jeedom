...
function myLogger(debugLevel,logger,creationLogPath) {
	...
	this.log = function(level, msg) {
		...
		if(this.debugLevel > debug.DEBUG && (level == "debug" || level == "|debug")) {return;}
		if(this.debugLevel > debug.INFO && (level == "info" || level == "|info")) {return;}
		if(this.debugLevel > debug.WARNING && (level == "warning" || level == "|warning")) {return;}
		if(this.debugLevel > debug.ERROR && (level == "error" || level == "|error")) {return;}
